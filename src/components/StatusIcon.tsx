...
export const Approved: React.FC<Props> = ({ className }: Props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" className={className}>
    <path d="M12 2C6.5 2 2 6.5 2 12S6.5 22 12 22 22 17.5 22 12 17.5 2 12 2M10 17L5 12L6.41 10.59L10 14.17L17.59 6.58L19 8L10 17Z" />
  </svg>
);

export const ApprovedWithSuggestions: React.FC<Props> = ({ className }: Props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" className={className}>
...
export const NoVote: React.FC<Props> = ({ className }: Props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" className={className}>
...
export const WaitingOnAuthor: React.FC<Props> = ({ className }: Props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" className={className}>
    <path d="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M16.2,16.2L11,13V7H12.5V12.2L17,14.9L16.2,16.2Z" />
  </svg>
);

export const Rejected: React.FC<Props> = ({ className }: Props) => (
  <svg width="24" height="24" viewBox="0 0 24 24" className={className}>
