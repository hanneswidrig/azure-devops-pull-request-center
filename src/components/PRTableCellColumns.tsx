...
export const titleColumn = (rowIndex: number, columnIndex: number, tableColumn: ITableColumn<PR>, tableItem: PR): JSX.Element => (
...
export const reviewersColumn = (rowIndex: number, columnIndex: number, tableColumn: ITableColumn<PR>, tableItem: PR): JSX.Element => {
